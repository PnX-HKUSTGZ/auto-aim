...
constexpr double MAX_RUNE_DISTANCE = 12.0;

// Rune object points
// r_tag, arm_bottom, arm_top, hit_bottom, hit_left, hit_top, hit_right
const std::vector<cv::Point3f> RUNE_OBJECT_POINTS = {
    cv::Point3f(0, 0, 0) / 1000,      cv::Point3f(0, -184, 0) / 1000,
    cv::Point3f(0, -514, 0) / 1000,   cv::Point3f(0, -600, 0) / 1000,
    cv::Point3f(0, -700, 100) / 1000, cv::Point3f(0, -800, 0) / 1000,
    cv::Point3f(0, -700, -100) / 1000};
