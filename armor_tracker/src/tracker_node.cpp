...
: Node("armor_tracker", options)
{
    ...
    tracker_manager_ = std::make_unique<TrackerManager>(
        ...
        this->declare_parameter("tracker.outpost_match_count_threshold", 9),
        this->declare_parameter("tracker.outpost_z_lost_threshold", 0.03),
        this->declare_parameter("tracker.outpost_z_mismatch_reinit_rounds", 8),
